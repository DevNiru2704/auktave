  ...
  return (
    <div className="pt-32 pb-24 px-5 lg:px-10 vines-bg" data-testid="events-page">
      <div className="max-w-7xl mx-auto">
        ...
        <GlitchText as="h1" className="text-6xl lg:text-8xl mb-6">Events / Games</GlitchText>
        <p className="text-bone/70 text-lg max-w-2xl mb-14">
          Seven games. One arena. Pick the ones that match your edge. The Hackathon is the headline, but every game has the same prestige and prizes proportional to the challenge.
        </p>
        ...
        <p className="eyebrow mb-4">/ Side Games</p>
