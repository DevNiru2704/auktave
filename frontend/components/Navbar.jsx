  ...
  return (
    ...
    >
      ...
      <div className={`transition-all duration-300 ${
        scrolled ? "bg-ink/85 backdrop-blur-md border-b border-ember/20" : "bg-gradient-to-b from-ink/70 to-transparent"
      }`}>
          ...
          {links.map((l) => (
            <li key={l.href}>
              <Link
                ...
                className={`uppercase font-mono text-xs tracking-[0.2em] transition-colors ${
                  pathname === l.href ? "text-signal" : "text-bone/70 hover:text-ember"
                }`}
              >
                {l.label}
              </Link>
